...
public class JavaExample {
    ...
    public static void main(String[] args) {
        ...
        RoutingHttpHandler routing =RoutingKt.bind("/path", Method.POST).to(req -> Response.Companion.create(Status.ACCEPTED));
        ...
        System.out.println(client.invoke(Request.Companion.create(Method.POST, "http://localhost:8000/path").body("1234567890")));
